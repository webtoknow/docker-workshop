# [![docker.com](https://www.docker.com/favicons/favicon-32x32.png)](https://www.docker.com/) Docker workshop - Compose
...
We use the base image of `node:7.10.0-alpine`. It is the official image in Alpine, a minimal OS.
